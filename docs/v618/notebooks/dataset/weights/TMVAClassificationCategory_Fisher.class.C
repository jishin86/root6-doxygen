...
{
   fFisher0 = -0.0233784980026;
   fFisherCoefficients.push_back( -0.0529463889001 );
   fFisherCoefficients.push_back( -0.0136473747837 );
   fFisherCoefficients.push_back( 0.0960349295198 );
   fFisherCoefficients.push_back( 0.21637932158 );
